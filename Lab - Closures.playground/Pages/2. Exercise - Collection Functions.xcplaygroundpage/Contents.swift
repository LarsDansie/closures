...
let names = ["Austin", "Hyrum", "April", "Jade", "Daniel", "Jack"]

let sortedNames = names.sorted(by: forwards(name1:name2:))
...
let newSortedNames = names.sorted { (firstName, secondName) ->
    Bool in
        return firstName < secondName
}

let sortedCollection2 = newSortedNames
...
let evenBetterSortedNames = names.sorted(by: <)
let sortedCollection3 = evenBetterSortedNames
